...
// Add lines like this to spawn processes at startup.gnome
...
spawn-at-startup "swaybg -i ${../../nixos-installs/wallpapers/purple-paper.jpg} -m center"
spawn-at-startup "dunst"
spawn-at-startup "ghostty --command='cd ~/shared/personal/orgmode; nvim' --window-decoration=none --confirm-close-surface=false"
...
binds {
    ...
    Mod+Q     { focus-column-left; }
    Mod+W     { focus-column-right; }
    ...
    Mod+Ctrl+Q     { move-column-left; }
    Mod+Ctrl+W     { move-column-right; }
    ...
    Mod+Shift+0 { focus-column-first; }
    Mod+Shift+4  { focus-column-last; }
    Mod+Shift+Ctrl+0 { move-column-to-first; }
    Mod+Shift+Ctrl+4  { move-column-to-last; }
